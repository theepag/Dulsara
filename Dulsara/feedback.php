...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<div align ='center';  style='width: 200;padding:20px; height: 100; font-size: 50px; font-family: verdana; color:#003366; filter: blur(add = 1, direction = 220, strength = 10)' > Current Rating:";
