									...
									<!-- Navbar content -->
										<div class="container" style="font-family:navfont; font-color:White;">
											<img src="../Images/logo.png" alt="Dulsara logo">
												<div id="navcontent">
													<a class="navbar-brand" style="color:White; font-family:Verdana;" href="../home_cus.php">Home</a>
													<a class="navbar-brand" style="color:White; font-family:Verdana;" href="ordernow.php">Meals</a>
													<a class="navbar-brand" style="color:White; font-family:Verdana;" href="./view_order.php">My orders</a>
