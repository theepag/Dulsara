                      ...
                      <div class="container" style="font-family:navfont; font-color:White;">
                        <img src="Images/logo.png" alt="Dulsara logo">
                          <div id="navcontent">
                            ...
                            <option value=""> <a class="navbar-brand" href=" " style="color:Red;margin-left:150px;font-family:Verdana;"><?php echo $row; ?></a></option>
                            <option value="logout.php"> <a class="navbar-brand"  style="color:Red;margin-left:150px;font-family:Verdana;">logout</a></option>
                              ...
                              <div class="col-md-6">
                                ...
                                <h3>Reserve Date:</h3>
                                 <!-- date-->
                                  ...
                                  <input type="date" name="date" min="2019-02-21" max="2020-12-31" class="form-control cus_form" required="required" placeholder="Select Your date" /><br>
